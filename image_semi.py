...
def process_image(filepath):
    ...
    for faceBox in faceBoxes:
        ...
        cv2.putText(image, f'{gender}', (faceBox[0], faceBox[1]-10), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0,0,255), 4, cv2.LINE_AA)

    # Display count of males and females
    cv2.putText(image, f'Males: {men_count}, Females: {women_count}', (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0,0,255), 4, cv2.LINE_AA)
